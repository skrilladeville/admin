...
Route::post('authenticate', 'Auth\AuthController@authenticate');
  ...
  Route::get('user/branch/view/{id}', 'Users\BranchController@show');
   ...
   //catalog vendor
    ...
    Route::patch('users/profilePatient/edit/{user_id}', 'Users\ProfilePatientController@update');
...
//Route::group(['middleware' => 'jwt.auth'], function () {
    ...
    Route::get('sales/tax/{id}', 'Sales\TaxController@index');
    Route::get('sales/tax_tiers', 'Sales\TaxController@getTaxTiers');
    Route::get('sales/tax_tier/{id}', 'Sales\TaxController@getTaxTier');
    Route::get('sales/tax_rates/{id}', 'Sales\TaxController@getTaxRates');
    Route::post('sales/tax_tier/new', 'Sales\TaxController@newTaxTier');
    Route::post('sales/tax_tier/edit/{id}', 'Sales\TaxController@editTaxTier');
    Route::get('sales/tax_settings/{id}', 'Sales\TaxController@getTaxSettings');
    Route::get('sales/shipment_tax', 'Sales\TaxController@getShipmentTax');
    Route::put('sales/shipment_tax/update', 'Sales\TaxController@updateShipmentTax');
