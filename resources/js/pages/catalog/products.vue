<template>
  <div class="app-container">
    ...
    <el-dialog  title="Check In Product" :before-close="clearData" :visible.sync="dialogCheckIn" width="60%" center>
      <el-form label-position="top" size="mini" :model="form" ref="form">
        ...
        <el-row :gutter="10">
          ...
          >
            <el-option :label="vendor.name" v-for="vendor in vendors" :value="vendor.id" :key="vendor.id"></el-option>
          </el-select>
        </el-form-item>
          </el-col>
          <el-col :md="12">
          ...
          >
            <el-option label="Msterdam Gardens" value="1"></el-option>
  ...
  v-model="form.harvest_date"
      ...
      <el-row :gutter="5">
        <el-col :md="4">
           <el-form-item label="Jar,g">
            <el-input  type="number" v-model="form.by_weight.jar_g"><template slot="append">
        g
         </template></el-input>
            </el-form-item>
        </el-col>
          <el-col :md="4">
            ...
            <el-input  type="number" v-model="form.by_weight.one_g"><template slot="append">
        pcs
         </template></el-input>
         <p class="convert">{{one_g_cal}} g</p>
          ...
          <el-col :md="4">
            ...
            <el-input  type="number" v-model="form.by_weight.eight_oz"><template slot="append">
        pcs
         </template></el-input>
         <p class="convert">{{eigth_oz_to_g}} g</p>
          ...
          <el-col :md="4">
            ...
            <el-input  type="number" v-model="form.by_weight.fourth_oz"><template slot="append">
        ...
        pcs
          ...
          <el-col :md="4">
            ...
            <el-input  type="number" v-model="form.by_weight.half_oz"><template slot="append">
        pcs
         </template></el-input>
         <p class="convert">{{half_oz_to_g}} g</p>
          ...
          <el-col :md="4">
            ...
            <el-input  type="number" v-model="form.by_weight.one_oz"><template slot="append">
        pcs
         </template></el-input>
      ...
      <el-row :gutter="5">
        <el-col :md="6">
            ...
            <el-input disabled v-model="form.total_weight"  type="number" :value="total_weight"><template slot="append">
        g
         </template></el-input>
        ...
        <el-col :md="6">
            ...
            <el-input  type="number" v-model="form.cost_per_gram"><template slot="prepend">
        $
         </template></el-input>
        ...
        <el-col :md="12">
            ...
            <el-input  type="number" v-model="form.total_cost" :value="total_cost"><template slot="prepend">
        $
         </template></el-input>
      ...
      <el-row :gutter="5">
          ...
          >
            ...
            <el-option label="Stripe ($500,000,094,158,848.00)" value="4"></el-option>
             <el-option label="Quincy And Priscilla Adams ($125,800,011,530,240.00)" value="5"></el-option>
        ...
        <el-col :md="8">
            ...
            <el-input  type="number" v-model="form.payment_amount" :value="total_cost"><template slot="prepend">
            $
            </template></el-input>
        ...
        <el-col :md="4">
          <el-form-item label=" ">
  <el-button size="small" type="primary" @click="paidFull">
              Paid In Full
          </el-button>
          </el-form-item>
      ...
      <template v-if="price_measurement == 'Weight Range'">
        ...
        <el-col :md="6">
            <el-form-item label="Weight">
            <el-input v-model="form.total_weight"  type="number" :value="total_weight"><template slot="append">
        g
         </template></el-input>
  ...
  <el-button size="small" type="primary" @click="paidFull">
      ...
      <template v-if="price_measurement =='Per Unit' || price_measurement =='Per Unit Range'">
        ...
        <el-col :md="6">
            ...
            <el-input v-model="form.total_quantity"  type="number"><template slot="append">
        pcs
         </template></el-input>
        ...
        <el-col :md="6">
            ...
            <el-input  type="number" v-model="form.cost_per_piece"><template slot="prepend">
        $
         </template></el-input>
        ...
        <el-col :md="12">
                <el-form-item label="Total Cost">
            <el-input  type="number" v-model="form.total_cost" :value="total_cost_per_piece"><template slot="prepend">
        $
         </template></el-input>
  ...
  <el-form-item label="Note">
    <el-input v-model="form.note" type="textarea">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogCheckIn = false">Save</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  computed:{
    one_g_cal:function(){
     ...
     total_weight:function(){
      ...
      this.form.total_weight=parseFloat(one_oz) + parseFloat(half_oz) + parseFloat(fouth_oz) 
      + parseFloat(eigth_oz) + parseFloat(one_g) + parseFloat(jar_g)

      console.log(`total ${this.form.total_weight}`)

      return parseFloat(one_oz) + parseFloat(half_oz) + parseFloat(fouth_oz) 
      + parseFloat(eigth_oz) + parseFloat(one_g) + parseFloat(jar_g)
     
     },
     total_cost:function(){
       this.form.total_cost=parseFloat(this.form.total_weight) * parseFloat(this.form.cost_per_gram)
       return parseFloat(this.form.total_weight) * parseFloat(this.form.cost_per_gram)
     },
     total_cost_per_piece:function(){
       this.form.total_cost=parseFloat(this.form.total_quantity) * parseFloat(this.form.cost_per_piece)
       return parseFloat(this.form.total_quantity) * parseFloat(this.form.cost_per_piece)
  ...
  methods: {
    ...
    paidFull(){
      console.log("ni abot")
      this.form.payment_amount=this.form.total_cost
    },
