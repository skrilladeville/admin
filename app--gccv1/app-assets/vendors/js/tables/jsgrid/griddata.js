        ...
        loadData: function(filter) {
            return $.grep(this.clients, function(client) {
                return (!filter.Name || client.Name.indexOf(filter.Name) > -1)
                    && (!filter.DateApppointment || client.DateApppointment.indexOf(filter.DateApppointment))
                    && (!filter.TimeFrom || client.TimeFrom.indexOf(filter.TimeFrom))
                    && (!filter.TimeTo || client.TimeTo.indexOf(filter.TimeTo))
                    && (!filter.Mobile || client.Mobile.indexOf(filter.Mobile))
                    && (!filter.Email || client.Email === filter.Email)
                    && (!filter.RemCondition || client.RemCondition.indexOf(filter.RemCondition) > -1)
            });
        },
    ...
    db.clients = [
        {
            ...
            "Time To": "10:00",
            "Mobile": "444543564",
            "Email": "ottoclay@gmail.com",
            "Remarks":"Follow up checkup",
        },
        {
            "Name": "Connor Johnston",
            "DateApppointment":"2018-12-04",
            "TimeFrom": "10:00",
            "TimeTo": "10:30",
            "Mobile": "444543564",
            "Email": "connorjohnston@gmail.com",
            "RemCondition":"Follow up checkup",
        },
        {
            "Name": "Lacey Hess",
            "DateApppointment":"2018-12-04",
