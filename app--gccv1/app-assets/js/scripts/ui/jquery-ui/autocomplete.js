...
$(document).ready(function(){
	...
	************************************/
    ...
    $(".ac-remote-datasource").autocomplete({
        source: "https://pixinvent.com/bootstrap-admin-template/robust/app-assets/data/jquery-ui/search.php",
        minLength: 2
    });
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("https://pixinvent.com/bootstrap-admin-template/robust/app-assets/data/jquery-ui/search.php", request, function(data, status, xhr) {
                cache[term] = data;
                response(data);
            });
        }
    ...
    .autocomplete({
        source: function(request, response) {
					...
					$.getJSON("http://pxs-pc/GCCv1/gcis/patients-searchNames.json", {
