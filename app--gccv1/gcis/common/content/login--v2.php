			...
			<div class="col-md-12">
				<div class="compact form-group">
					<fieldset class="form-group">
						...
						<input type="text" class="form-control" name="username" id="user_name" value="<?= $fv['username'] ?>" placeholder="Username or Email Address"  required data-validation-required-message="Please enter your login username or email">
					</fieldset>
					<fieldset class="form-group">
						<label>Password</label>
						<input type="password" class="form-control" name="password" id="user_password" value="" placeholder="Password" required>
					</fieldset>
					<fieldset>
