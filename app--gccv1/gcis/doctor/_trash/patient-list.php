<?php /*?><?php 
  ...
  if(isset($_GET['delete'])){
    ...
    echo '</script>';
    echo "<script>window.location.href='../admin/patientlist.php'</script>";
  }?><?php */
            ...
            <?php while($user = mysqli_fetch_assoc($sql)) : ?>
              <tr>
                <td>
                  ...
                  <a href="../admin/patientlist.php?delete=<?= $user['id']; ?>" class="btn btn-default btn-xs badge badge-danger"><span class="glyphicon glyphicon-remove-sign"></span></a>
                </td>
